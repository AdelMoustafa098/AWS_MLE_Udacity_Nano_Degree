...
ACCEPTED_CONTENT_TYPE = [ PNG_CONTENT_TYPE ] #Adding only support for jpeg images for now
...
def net():
    ...
    model.fc = nn.Sequential( nn.Linear( num_features, 256), #Adding our own fully connected layers
                             ...
                             nn.Linear(256, 3),
                             nn.ReLU(inplace = True) # output should have 3 nodes as we have 3 classes of dog breeds
                            )
    return model
